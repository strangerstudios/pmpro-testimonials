...
function pmpro_testimonials_get_started() {
	...
	<div class="pmpro-new-install">
		...
		<a href="<?php echo esc_url_raw( admin_url( 'post-new.php?post_type=pmpro_testimonial' ) ); ?>" class="button-primary"><?php esc_html_e( 'Add a Testimonial', 'pmpro-testimonials' ); ?></a>
